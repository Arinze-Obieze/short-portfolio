                    ...
                    <div className="card-content">
                        ...
                        <div className="card-timeline">
                            ...
                            <div className="card-item" data-year="2023">
                                ...
                                <div className="card-item-desc"> Including but not limited to an E-Commerce website, Crypto web app. E.t.c </div>
                            </div>

                            <div className="card-item" data-year="2023">
                                <div className="card-item-title">Front-end Developer at <span>Murlist</span></div>
